...
class Encoder_Adapter(nn.Module):
    def __init__(self, params):
        super(Encoder_Adapter, self).__init__()
        self.params = params
        ...
        self.adapter = Adapter(self.ft_chns[4], self.ft_chns[4])
...
class Decoder_URPC_Adapter(nn.Module):
    def __init__(self, params):
        super(Decoder_URPC_Adapter, self).__init__()
        self.params = params
        self.in_chns = self.params['in_chns']
        self.ft_chns = self.params['feature_chns']
        self.n_class = self.params['class_num']
        ...
        self.adapter0 = Adapter(self.ft_chns[0],self.ft_chns[0])
        self.adapter1 = Adapter(self.ft_chns[1],self.ft_chns[1])
        self.adapter2 = Adapter(self.ft_chns[2],self.ft_chns[2])
        self.adapter3 = Adapter(self.ft_chns[3],self.ft_chns[3])
    ...
    def forward(self, feature, shape):
        ...
        x3 = feature[3]
        x4 = feature[4]
        x0_adapter = self.adapter0(x0)
        x1_adapter = self.adapter1(x1)
        x2_adapter = self.adapter2(x2)
        x3_adapter = self.adapter3(x3)

        x = self.up1(x4, x3_adapter)
        if self.training:
...
class UNet_URPC_Adapter(nn.Module):
    def __init__(self, in_chns, class_num):
        super(UNet_URPC_Adapter, self).__init__()
        ...
        params = {'in_chns': in_chns,
                  ...
                  'bilinear': False,
                  'acti_func': 'relu'}
        self.encoder = Encoder_Adapter(params)
        self.decoder = Decoder_URPC_Adapter(params)
